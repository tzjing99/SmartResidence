    ...
    >
        ...
        <Card>
          ...
          <Stack gap={8}>
            <Button
              ...
              onPress={() => confirm.mutate({ id: id!, confirmed: true })}
            />
      ...
      {rejectMode ? (
        <Card>
          ...
          <TextInput
            ...
            multiline
            style={{ borderWidth: 1, borderColor: palette.borderLight, borderRadius: 10, padding: 10, marginBottom: 8 }}
          />
          <TextInput
      ...
      {appealMode ? (
        <Card>
          ...
          />
          <Stack gap={8}>
            <Button title="Submit appeal" onPress={() => appeal.mutate({ id: id!, reason: appealReason })} />
      ...
      {t.messages.map((m) => (
        <View
          ...
          style={{
            ...
            backgroundColor: m.kind === 'SYSTEM' ? 'transparent' : palette.cardLight,
        ...
        >
          <Text style={{ fontSize: m.kind === 'SYSTEM' ? 11 : 14, color: m.kind === 'SYSTEM' ? palette.mutedLight : undefined }}>
            {m.body}
          </Text>
        </View>
      ))}
      ...
      {!pending && !finished ? (
        <Card>
          <TextInput
            ...
            multiline
            style={{ borderWidth: 1, borderColor: palette.borderLight, borderRadius: 10, padding: 10, minHeight: 80 }}
          />
          <View style={{ marginTop: 8 }}>
            <Button
              title="Send"
              onPress={() => {
                post.mutate({ id: id!, body });
                setBody('');
              }}
            />
          </View>
